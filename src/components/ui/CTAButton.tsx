...
const variants: Record<Variant, string> = {
  primary: 'bg-sun text-cocoa hover:bg-sun-deep hover:-translate-y-0.5 shadow-soft hover:shadow-lift',
  outline:
    'border border-gold/25 text-gold hover:border-gold/60 hover:bg-honey/50 hover:-translate-y-0.5',
  light: 'bg-white text-gold hover:bg-honey hover:-translate-y-0.5 shadow-soft',
  outlineLight:
    'border border-white/35 text-white hover:border-white/75 hover:bg-white/10 hover:-translate-y-0.5',
  ghost: 'text-gold hover:text-bronze underline-offset-4 hover:underline px-2 py-1',
}
